    ...
    useEffect(() => {
        ...
        loadPannellum().then(() => {
            ...
            viewerRef.current = window.pannellum.viewer(containerRef.current, {
                type: 'equirectangular', panorama: imageUrl, autoLoad: true, showControls: true,
                compass: false, friction: 0.15, mouseZoom: true, hfov: 85, yaw: 0, pitch: -10,
                minHfov: 70, maxHfov: 140, crossOrigin: 'anonymous',
            });
