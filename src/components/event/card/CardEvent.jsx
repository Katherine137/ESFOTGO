import { formatearFecha, getEstado } from '../../../utils/eventsUtils'
...
export const CardEvent = ({ evento }) => {
    ...
    return (
        ...
        <div className="relative">
            <img src={evento?.imagen || '/Logo.png'} alt="img-event" className="rounded-full border-2 border-gray-300 w-24 h-24 object-cover"/>
            {estado && (
