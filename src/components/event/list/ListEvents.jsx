...
import useListEvents from '../../../hooks/events/useListEvents'
import { formatearFecha } from '../../../utils/eventsUtils'

const HEADERS = ['N°', 'Nombre', 'Organizador', 'Ubicación', 'Fecha', 'Hora', 'Información', 'Imagen', 'Acciones']

const ListEvents = () => {
    const { eventos, loading, handleEliminar, handleEditar } = useListEvents()
    ...
    const EventRow = ({ index, evento, onEditar, onEliminar }) => (
